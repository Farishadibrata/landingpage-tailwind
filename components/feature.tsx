export const FeatureComponent = () => {
    return (
      <div className="px-4  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 pt-16 ">
          ...
          <div>
            <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50">
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <circle cx="11" cy="13" fill="none" r="9" stroke="#4f46e5" />
                <path
            ...
            <ul className="mb-4 -ml-1 space-y-2">
              <li className="flex items-start">
                <span className="mr-1">
                  <svg
                    className="w-5 h-5 mt-px text-indigo-600"
                    stroke="#4f46e5"
                    viewBox="0 0 52 52"
                  >
                    <polygon
            ...
            <a
              href="/"
              aria-label=""
              className="inline-flex items-center font-semibold transition-colors duration-200 text-indigo-600 hover:text-deep-purple-800"
            >
              Learn more
            </a>
          </div>
            ...
            <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50">
              ...
              >
                ...
                <polyline
                  ...
                  stroke="#4f46e5"
                />
                <path d="M8,23a7,7,0,0,1-7-7" fill="none" stroke="#4f46e5" />
                <path d="M8,19a3,3,0,0,1-3-3" fill="none" stroke="#4f46e5" />
              </svg>
            </div>
